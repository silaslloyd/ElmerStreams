...
geo_template = "Initialisation/template_flowline.geo"
#geo_template_2D = "Initialisation/template_2D.geo"

geo_output = "footprint.geo"
#geo_output_2D = "footprint2D.geo"

# Parameters you want to extract from Lua
keys = ["GL", "L", "GLRes","BoundaryRes","W", "y_nodes"]
...
#populate_geo_file(geo_template_2D, geo_output_2D, params)
