...
np.savetxt('Dimensional_ICs/H_dim.xy', H, fmt='%g', delimiter=' ')
watersheet = (CT+1)/2*(0.1-1e-4) + 1e-4
HW = np.column_stack((X, watersheet))
np.savetxt('Dimensional_ICs/GM_dim.xy', GM, fmt='%g', delimiter=' ')
np.savetxt('Dimensional_ICs/hw_dim.xy', HW, fmt='%g', delimiter=' ')
